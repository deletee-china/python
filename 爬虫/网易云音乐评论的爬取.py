    ...
    def getcontent(self,page):
        ...
        for page in tqdm(range(int(page))):
            ...
            for select in selector:
                ...
                with open ("../data/luoshenmen_comments.csv", 'a', encoding='utf-8')as f:
                    csv_write=csv.writer(f)
...
if __name__=='__main__':
    url='https://music.163.com/#/song?id=1456890009'
    yunSpider=YunSpider(url)
    yunSpider.getcontent(4580)
